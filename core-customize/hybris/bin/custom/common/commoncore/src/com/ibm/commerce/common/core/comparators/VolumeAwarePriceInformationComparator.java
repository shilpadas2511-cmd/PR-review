...
import de.hybris.platform.europe1.jalo.GeneratedPriceRow;
...
public class VolumeAwarePriceInformationComparator implements Comparator<PriceInformation>
{
	...
	{
		final Long o1Quantity = (Long) priceInfo1.getQualifierValue(GeneratedPriceRow.MINQTD);
		final Long o2Quantity = (Long) priceInfo2.getQualifierValue(GeneratedPriceRow.MINQTD);
