 ...
 * PartnerB2BUnitModel
 */
public class IbmB2BUnitBasicDetailsReversePopulator implements
    ...
    public void populate(final IbmB2BUnitData source, final IbmB2BUnitModel target)
        ...
        if (StringUtils.isNotBlank(source.getIbmCustomerNumber())) {
            target.setId(source.getIbmCustomerNumber());
        }
    }
}
