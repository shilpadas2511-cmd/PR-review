...
/**
 * Generic Runtime Exception to be used
 */
public class IbmRuntimeException extends RuntimeException
{
	/**
	 * Constructs a new runtime exception with {@code null} as its detail message. The cause is not initialized, and may
	 * subsequently be initialized by a call to {@link #initCause}.
	 */
	public IbmRuntimeException()
	{
		super();
	}
	 ...
	 */
	public IbmRuntimeException(final String message)
	{
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public IbmRuntimeException(final String message, final Throwable cause)
	{
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public IbmRuntimeException(final Throwable cause)
	{
		super(cause);
	}
	 ...
	 * @since 1.7
	 */
	protected IbmRuntimeException(final String message, final Throwable cause, final boolean enableSuppression,
