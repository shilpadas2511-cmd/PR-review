...
public class DefaultPartnerCpqCpiQuoteSubmitterMapperService implements
    ...
    public DefaultPartnerCpqCpiQuoteSubmitterMapperService(
    ...
    public void map(IbmPartnerQuoteModel quoteModel,
        ...
        if (quoteModel.getCreator() instanceof B2BCustomerModel customerModel) {
            ...
            sapcpqOutboundQuoteCustomerModel.setName(quoteModel.getSubmitter().getName());
        }
        sapcpqOutboundQuoteCustomerModel.setRoleType(PartnercoreConstants.QUOTE_SUBMITTER_CPQ);
