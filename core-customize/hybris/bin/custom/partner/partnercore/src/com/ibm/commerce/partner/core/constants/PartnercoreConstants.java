...
public final class PartnercoreConstants extends GeneratedPartnercoreConstants {
    ...
    public static final String DUPLICATE_QUOTE_PROCESS_CODE = "partner-cpq-clone-quote-process";
    public static final String COPY_QUOTE_ACTION_LOG_FAILURE = "Failed to copy quote info for quote: {}";
    public static final String CPQ_COPY_QUOTE_CONSUMED_DESTINATION_ID = "cpqCopyQuoteService";
    public static final String CPQ_COPY_QUOTE_CREATION_CONSUMED_DESTINATION_ID = "cpqCopyQuoteCreationService";
    public static final String CPQ_UPDATE_QUOTE_DETAILS_CONSUMED_DESTINATION_ID = "cpqUpdateQuoteService";
    public static final String CPQ_UPDATE_QUOTE_DETAILS_DESTINATION_TARGET_ID = "cpqUpdateQuoteHeaderService";
    public static final String CPQ_UPDATE_QUOTE_ERROR_MESSAGE = "No CPQ Quote ID found for quote: ";
    public static final String NO_QUOTE_FOUND_IN_PROCESS_MODEL = "No quote found in process model: {}";
    public static final String FOR_QUOTE_NUMBER = "{} for Quote [{}]";
    public static final String COPY_QUOTE_RESPONSE_NULL_OR_MISSING = "Copy quote response is null or missing newCopyQuoteId for Quote [{}]";

    public static final String CPQ_REMOVE_CONFIGURED_PRODUCTS_CONSUMED_DESTINATION_ID = "cpqRemoveConfigurationService";
    public static final String CPQ_REMOVE_CONFIGURED_PRODUCT_DESTINATION_ID = "removeConfigurationService";
    public static final String CPQ_FLOW_FOR_REMOVE_PRODUCT_CONFIG_FALIED ="CPQ flow for Remove Product COnfiguration falied";
    public static final String REMOVE_ENTRY ="Removing entry: ";
    public static final String REMOVE_PRODUCT_CONFIG_ID = "Removing CPQ config with ID: ";
    public static final String QUOTE_ID_FROM_CPQ ="cpqQuoteId";
    public static final String PREPARE_REMOVE_PRODUCT_CONFIG_REQUEST_DATA = "Preparing the request for Remove Product Configuration";
    public static final String ERROR_IN_UPDATING_CART= "Error in updateQuantityForCartEntry for cart ID [{}]";
}
