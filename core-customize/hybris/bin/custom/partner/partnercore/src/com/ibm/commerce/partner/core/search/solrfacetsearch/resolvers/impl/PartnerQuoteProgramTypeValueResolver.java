...
/*
 *  This class will provide data program type
 */
public class PartnerQuoteProgramTypeValueResolver extends
    ...
    protected void addFieldValues(final InputDocument inputDocument,
        ...
        IbmPartnerAgreementDetailModel agreementDetail = ibmPartnerQuoteModel.getAgreementDetail();
        if (agreementDetail != null) {
            inputDocument.addField(indexedProperty, agreementDetail.getProgramType());
        }
    }
