...
/**
 * This resolver class is to get the cartID from quote
 */
public class PartnerQuoteCartReferenceIdValueResolver
    ...
    protected void addFieldValues(InputDocument inputDocument,
        ...
        if (ibmPartnerQuoteModel.getCartReference() != null) {
            inputDocument.addField(indexedProperty,
                ibmPartnerQuoteModel.getCartReference().getCode());
        }
