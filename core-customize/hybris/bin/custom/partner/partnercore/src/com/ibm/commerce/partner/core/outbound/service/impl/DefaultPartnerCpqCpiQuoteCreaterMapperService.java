...
public class DefaultPartnerCpqCpiQuoteCreaterMapperService implements
    ...
    public DefaultPartnerCpqCpiQuoteCreaterMapperService(
    ...
    public void map(IbmPartnerQuoteModel quoteModel,
        Set<SAPCPQOutboundQuoteCustomerModel> outboundQuoteCustomerModels) {
        ...
        sapcpqOutboundQuoteCustomerModel.setRoleType(PartnercoreConstants.QUOTE_CREATOR_CPQ);
        outboundQuoteCustomerModels.add(sapcpqOutboundQuoteCustomerModel);
    }
