...
@UnitTest
public class DefaultPartnerCpqCpiQuoteCreaterMapperServiceTest {

    private static final String TEST_EMAIL = "creator@partner.com";
    private static final String TEST_NAME = "John Partner";

    private DefaultPartnerCpqCpiQuoteCreaterMapperService mapperService;
    ...
    public void setUp() {
        ...
        mapperService = new DefaultPartnerCpqCpiQuoteCreaterMapperService(customerEmailResolutionService);
        outboundSet = new HashSet<>();
    }

    @Test
    public void testMap_WithB2BCustomer_CreatesCustomerModelWithEmailAndName() {
        ...
        Assert.assertEquals(PartnercoreConstants.QUOTE_CREATOR_CPQ, result.getRoleType());
    }

    @Test
    public void testMap_WithNonB2BCustomer_CreatesCustomerModelWithOnlyRoleType() {
        ...
        Assert.assertEquals(1, outboundSet.size());
        SAPCPQOutboundQuoteCustomerModel result = outboundSet.iterator().next();
        Assert.assertNull(result.getCustomerCode());
        Assert.assertNull(result.getName());
        Assert.assertEquals(PartnercoreConstants.QUOTE_CREATOR_CPQ, result.getRoleType());
    }

    @Test
    public void testGetCustomerEmailResolutionService() {
