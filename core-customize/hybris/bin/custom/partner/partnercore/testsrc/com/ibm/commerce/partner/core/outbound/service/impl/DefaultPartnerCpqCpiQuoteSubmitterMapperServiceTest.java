...
@UnitTest
public class DefaultPartnerCpqCpiQuoteSubmitterMapperServiceTest {

    private static final String TEST_EMAIL = "submitter@partner.com";
    private static final String TEST_NAME = "Submitter Name";

    private DefaultPartnerCpqCpiQuoteSubmitterMapperService mapperService;
    ...
    public void setUp() {
        ...
        mapperService = new DefaultPartnerCpqCpiQuoteSubmitterMapperService(customerEmailResolutionService);
        outboundSet = new HashSet<>();
    }

    @Test
    public void testMap_WithB2BCustomer_PopulatesEmailAndSubmitterName() {
        Mockito.when(quoteModel.getCreator()).thenReturn(b2bCustomerModel);
        Mockito.when(quoteModel.getSubmitter()).thenReturn(b2bCustomerModel);
        ...
        Assert.assertEquals(PartnercoreConstants.QUOTE_SUBMITTER_CPQ, result.getRoleType());
    }
    ...
    @Test
    public void testGetCustomerEmailResolutionService_ReturnsInjectedService() {
